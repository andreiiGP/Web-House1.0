...
-->
  ...
  <section class="contact-us" id="contact-section">
    <div class="container">
        <div class="col-lg-4">
          <form id="contact" action="iniciar" method="post">
            <div class="row">
              <div class="col-lg-12">
              ...
              <div class="col-lg-12">
                <fieldset>
                  <input type="text" name="user" id="user" placeholder="Nombre de Usuario" autocomplete="oF" required="">
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
              ...
              <div class="col-lg-12">
                <fieldset>
                  <button type="submit" id="form-submit" class="main-gradient-button">Loguin</button>
                </fieldset>
              </div>
            </div>
          </form>
